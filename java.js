            ...
            var colorTecla = "rgb(70, 67, 67)";
            var colorMargen = "white";
            var inicioX = 200;
            var inicioY = 300;
            var lon = 35;
            var margen = 20;
            var palabrita = prompt("digite la palabra que su amigo adivinara").toUpperCase()
            console.log(palabrita.split(" "))
        

            /* Arreglos */
            var teclas_array = new Array();
            var letras_array = new Array();
            var palabras_array = palabrita.split(" ");
            ...
            palabras_array.push("ZANAHORIA")
            palabras_array.push("UKELELE")
            palabras_array.push("DRACULA")
            palabras_array.push("PERRO")
            palabras_array.push("SOL")
            palabras_array.push("ESTRELLAS")
            palabras_array.push("CARNE")
            palabras_array.push("TECLADO")
            palabras_array.push("CELULAR")
            palabras_array.push("PANTALLA")
            palabras_array.push("PAJARO")
            palabras_array.push("SUPERMAN")
            palabras_array.push("AUDIFONOS")
            palabras_array.push("CAMA")
            palabras_array.push("NOCHE")
            ...
            */
            ...
            function gameOver(errores){
                ...
                if (errores < 5){
                    ctx.fillText("Epa ganaste, la palabra es: ", 110, 280); 
                } else {
                    ctx.fillText("Nah perdio, la palabra era: ", 110, 280);
                }
